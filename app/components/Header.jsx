...
function Header() {
  ...
  const handleNaviagteToBlogs = () => router.push("/blogs");
  ...
  return (
    <header className="py-5 sm:px-10 px-2 bg-gray-800 flex justify-between">
      <div
      ...
      <div className="routes hidden sm:flex gap-2 sm:gap-10 ">
        <button className="Blog cursor-pointer" onClick={handleNaviagteToBlogs}>
          Blog
        </button>
        <button
